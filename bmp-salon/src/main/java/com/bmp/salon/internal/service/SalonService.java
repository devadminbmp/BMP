package com.bmp.salon.internal.service;
...
import com.bmp.salon.internal.repository.SalonHoursRepository;
import com.bmp.salon.internal.repository.SalonPolicyRepository;
import com.bmp.salon.internal.repository.SalonRepository;
import com.bmp.salon.internal.repository.SalonServiceRepository;
...
public class SalonService {
    ...
    @Transactional
    public SalonResponse create(CreateSalonRequest req) {
    ...
    public ServiceResponse addService(UUID salonId, ServiceRequest req) {
        salons.findById(salonId).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "SALON_NOT_FOUND"));
        com.bmp.salon.internal.entity.SalonService svc = new com.bmp.salon.internal.entity.SalonService(
    ...
    private ServiceResponse toServiceResponse(com.bmp.salon.internal.entity.SalonService s) {
