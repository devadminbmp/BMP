...
import com.bmp.salon.internal.repository.StylistRepository;
import com.bmp.salon.internal.repository.StylistSalonRepository;
import com.bmp.salon.internal.repository.StylistServiceRepository;
...
public class StylistCrudService {
    ...
    public StylistServiceResponse addService(UUID salonId, UUID stylistId, StylistServiceRequest req) {
        com.bmp.salon.internal.entity.StylistService entity = new com.bmp.salon.internal.entity.StylistService(
    ...
    private StylistServiceResponse toStylistServiceResponse(com.bmp.salon.internal.entity.StylistService s) {
