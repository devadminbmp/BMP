...
VALUES
  ...
  ('00000000-0000-7000-0003-000000000003', '00000000-0000-7000-0001-000000000001', 'Deep-tissue massage (60 min)',220000,  60, true, now(), now()),
  ('00000000-0000-7000-0003-000000000004', '00000000-0000-7000-0001-000000000001', 'Hydrating facial',            180000,  50, true, now(), now()),
  ('00000000-0000-7000-0003-000000000005', '00000000-0000-7000-0001-000000000002', 'Classic haircut',              55000,  40, true, now(), now()),
  ('00000000-0000-7000-0003-000000000006', '00000000-0000-7000-0001-000000000002', 'Hot-towel shave',              45000,  30, true, now(), now()),
  ('00000000-0000-7000-0003-000000000007', '00000000-0000-7000-0001-000000000002', 'Beard trim & shape',           35000,  25, true, now(), now()),
  ('00000000-0000-7000-0003-000000000008', '00000000-0000-7000-0001-000000000003', 'Bridal makeup (trial)',       500000,  90, true, now(), now()),
  ('00000000-0000-7000-0003-000000000009', '00000000-0000-7000-0001-000000000003', 'Bridal package (full day)',  2500000, 300, true, now(), now()),
  ('00000000-0000-7000-0003-000000000010', '00000000-0000-7000-0001-000000000003', 'Gel manicure',                120000,  45, true, now(), now()),
  ('00000000-0000-7000-0003-000000000011', '00000000-0000-7000-0001-000000000004', 'Precision cut',                70000,  45, true, now(), now()),
  ('00000000-0000-7000-0003-000000000012', '00000000-0000-7000-0001-000000000004', 'Keratin treatment',           450000, 150, true, now(), now()),
  ('00000000-0000-7000-0003-000000000013', '00000000-0000-7000-0001-000000000005', 'Aromatherapy massage (90 min)',300000, 90, true, now(), now()),
  ('00000000-0000-7000-0003-000000000014', '00000000-0000-7000-0001-000000000005', 'Couples'' therapy session',   550000,  90, true, now(), now()),
  ('00000000-0000-7000-0003-000000000015', '00000000-0000-7000-0001-000000000006', 'Blow-dry & style',             60000,  35, true, now(), now()),
  ('00000000-0000-7000-0003-000000000016', '00000000-0000-7000-0001-000000000006', 'Nail art (per set)',           90000,  60, true, now(), now()),
  ('00000000-0000-7000-0003-000000000017', '00000000-0000-7000-0001-000000000007', 'Barber cut',                   65000,  40, true, now(), now()),
  ('00000000-0000-7000-0003-000000000018', '00000000-0000-7000-0001-000000000008', 'Gel extensions',               45000,  75, true, now(), now())
ON CONFLICT (id) DO NOTHING;
...
--   SELECT count(*) FROM salon_schema.salon_service;  -- 18
